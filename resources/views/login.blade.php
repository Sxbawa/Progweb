  ...
  <body>
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card w-25">
            ...
            <strong><span class="text-light">Form Login</span></strong></div>
            <div class="card-body">
                <form action="/ceklogin" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Masukan E-Mail" class ="form-control" required>
                    </div>
                    ...
                    <hr>
                    <samp class="d-flex justify-content-center">ATAU</samp>
